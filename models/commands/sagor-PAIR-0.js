const SAGOR= "SAGOR-PROJECT"; // Original credit
...
module.exports.run = async function({ api, event, Threads, Users }) {
  ...
  if (module.exports.config.credits !== SAGOR) {
    return api.sendMessage("DON'T CHANGE CREDIT! SAGOR-PROJECT FUCK YOUR MOTHER AND SISTER", event.threadID, event.messageID);
  }
  ...
  var msg = {
    body: `নেও তোমার জীবন সাথী মিলে গেছে 🙂🖐️\nআর বার বার বলবি না যে সিস্টেম করাই দে 😒👈\nতোমাদের ভালোবাসা 🙈👉 ${tle}% है\n`+namee+" "+"💖"+" "+name, 
    mentions: arraytag, 
    attachment: imglove
  };
