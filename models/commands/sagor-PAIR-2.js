...
var one = senderID, two = id;
    return makeImage({ one, two }).then(path => api.sendMessage({ body: `🌺${namee}🌺 নেও বানাই দিলাম তোমার জুটি 🌺${name}🌺 \nআর বার বার বলবি না সিটিং করাই দে 😒👈 『$le}』`, mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
}
